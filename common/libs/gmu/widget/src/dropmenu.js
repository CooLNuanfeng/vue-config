...
(function ($, undefined) {
    ...
    $.ui.define('dropmenu', {
        _data:{
            ...
            closeDropMenuSelector: "" //解决iPhone document你能委托click事件
        },
        ...
        show:function (target) {
            ...
            data.autoClose && $(data.closeDropMenuSelector).on('click.' + this.id(), function (e) {
        ...
        destroy:function () {
            ...
            data.autoClose && $(data.closeDropMenuSelector).off('click.' + this.id());
