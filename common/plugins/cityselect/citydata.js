(function ($)
{
	FLNS.register('Fanli.Province.Data');

	Fanli.Province.Data.add("GP", function ()
	{
		return ['安徽省', '北京市', '福建省', '甘肃省', '广东省', '广西壮族自治区', '贵州省', '海南省', '河北省', '河南省', '黑龙江省', '湖北省', '湖南省', '吉林省', '江苏省', '江西省', '辽宁省', '内蒙古', '宁夏回族自治区', '青海省', '山东省', '山西省', '陕西省', '上海市', '四川省', '天津市', '西藏自治区', '新疆维吾尔族自治区', '云南省', '浙江省', '重庆市'];
	});

	Fanli.Province.Data.add("GT", function ()
	{
		return [
	...
	Fanli.Province.Data.add("GC", function ()
	{
		return [
			[
				['长丰', '肥东', '肥西', '合肥市'],
			...
			[
				['宝山', '长宁', '崇明', '奉贤','虹口','黄浦','嘉定','金山','静安','卢湾','闵行','南汇','浦东新区','普陀','青浦','松江','徐汇','杨浦', '闸北']
			],
			[
